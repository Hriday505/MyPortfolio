...
export default function BackendProgress({ isdark = true }){


  const Skills = [

        {id:1,name:'Laravel',capability:"75"},
       
        {id:2,name:'Node.js',capability:"50"},

        {id:3,name:'Mysql',capability:"55"},
...
return (
    ...
    <>
        <Field className={`max-w-sm md:w-100 w-70 h-60 relative md:right-0 right-6 mt-8 md:mt-0 ml-12 p-8 rounded-2xl transition-colors duration-300 ${isdark ? "bg-[linear-gradient(135deg,rgba(255,255,255,0.18),rgba(255,255,255,0.06),rgba(255,255,255,0.02))]" : "bg-[linear-gradient(135deg,rgba(0,0,0,0.05),rgba(0,0,0,0.03),rgba(0,0,0,0.01))] border border-black/10"}`}>
        {Skills.map((item)=> (
